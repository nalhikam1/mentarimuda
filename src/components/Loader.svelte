...
<style>
  .loader-overlay {
    ...
    --hue: 20; /* Default sunset orange */
  }

  :global(.loader-visible) .loader-overlay {
    opacity: 1;
    pointer-events: all;
  }
  ...
  .loader {
    ...
    display: block;
    margin: auto;
    width: 100px; /* Reduced from 14em as it's an overlay */
    height: auto;
  }
  .loader__glare-top,
  ...
  @keyframes motion-thick {
    ...
    20% {
      ...
      stroke: rgb(220, 220, 220); /* Lighter for dark theme compatibility */
